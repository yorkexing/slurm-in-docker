...
curl https://raw.githubusercontent.com/open-mpi/ompi/v4.1.x/contrib/dist/linux/buildrpm.sh -o buildrpm.sh
chmod +x buildrpm.sh
...
cd -
./buildrpm.sh -b -s -c --with-slurm -c --with-pmi openmpi-4.1.5.tar.gz
